...
BEST_PASSING_FLUX family=horizontal_as_built value=2.27654e+06 row_id=CO00407 T_hs=273 screening=0 regime=deterministic_pair strain_bound=relaxed rep_rate_hz=8e+07
BEST_PASSING_FLUX_300K family=horizontal_as_built value=1.97467e+06 row_id=CO00223 T_hs=300 screening=0 regime=deterministic_pair strain_bound=relaxed rep_rate_hz=8e+07
...
horizontal_as_built T_hs=230K: at 80 MHz one_pair_valid=False optical_pass=False (row CO00359, g2=0.179324136421946, flux=3457024.318770842, delivered=122866.09454133948); at 200 MHz one_pair_valid=False optical_pass=False (row CO00360, g2=0.3168346309252512, flux=8630544.613331493, delivered=306776.87976046297). The 200 MHz period leaves less time per cycle for the deterministic-pair loading window, so a one_pair_valid failure there is a loading-window/period effect, not a fit.
horizontal_as_built T_hs=300K: at 80 MHz one_pair_valid=False optical_pass=False (row CO00383, g2=0.1792890886443651, flux=3467714.52640254, delivered=128792.56555700889); at 200 MHz one_pair_valid=False optical_pass=False (row CO00384, g2=0.3165284147670757, flux=8657131.143435951, delivered=321566.51162706804). The 200 MHz period leaves less time per cycle for the deterministic-pair loading window, so a one_pair_valid failure there is a loading-window/period effect, not a fit.
...
|---|---|---|---|---|---|---|---|
| 12.5 | 0.001 | 446.41772793972837 | 1.066861783858344 | 0.7917008239538932 (drive_mismatch) | 1390068.9541082678 | True | D1302963 |
| 12.5 | 0.002 | 446.4177252000232 | 1.0668421845337484 | 0.6903016283384055 (drive_mismatch) | 2536737.5901067983 | True | D1302964 |
| 15.0 | 0.001 | 446.2330005160856 | 1.0666577502540837 | 0.7910213051220907 (drive_mismatch) | 1369801.4318615806 | True | D1302965 |
| 15.0 | 0.002 | 446.2329979828811 | 1.0666381870417456 | 0.6895194267777083 (drive_mismatch) | 2498202.7016585306 | True | D1302966 |
...
runtime_s=1437.4 evaluate_calls=2983 complete=True
